            ...
            VStack {
                ...
                ScrollView {
                    ...
                    VStack(spacing: 20) {
                        ...
                        PetStatusComponent(name: "Saúde", icon: "heart", color: Color(red: 0.37, green: 0.82, blue: 0.8))
                        PetStatusComponent(name: "Passeios", icon: "heart", color: Color(red: 0.7, green: 0.87, blue: 0.33))
                    }
